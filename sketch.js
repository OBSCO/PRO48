...
function preload()
{
  ...
  CoheteEx = loadAnimation("CoheteD1.png","CoheteD2.png","CoheteD3.png","CoheteD4.png");
  ...
  CoheteEx.playing = true;
  CoheteEx.looping = false;
...
function setup() {
  ...
  lander.addAnimation("cohEx",CoheteEx);
  lander.scale = 0.07;
  //lander.debug = true;
...
function draw() 
{
  ...
  if(lander.isTouching(ground) ==true ){
    vx = 0;
    vy = 0;
    lander.changeAnimation("cohEx");
  }
  ...
  if((lander.isTouching(ater) == true) || lander.isTouching(obs)|| lander.isTouching(meteorito)|| lander.isTouching(meteorito2)){
    vx = 0;
    vy = 0;
    g = 0;
    blast = true;
